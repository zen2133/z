...
// @description  2022.02.02 更新，115转存助手ui优化版 v3.4 (143.2022.0202.1)(based on Fake115Upload 1.4.3 @T3rry)
// @author       Never4Ever
// @namespace    Fake115Upload@Never4Ever
// @version      143.2022.0202.1
// @match        https://115.com/*
...
(function () {
    ...
    const TIPS = {
        CurrentVersion: "143.2022.0202.1",
        LastUpdateDate: "2022.02.02",
        VersionTips: "115转存助手ui优化版 V3.4",
   ...
   function getEnviromentInfo(){
    ...
    function AddDownloadSha1Btn(jNode) {
        ...
        if (save != null && document.querySelector('#saveTip') == null) {
            save.insertAdjacentHTML('afterend', `<div id="saveTip"><p style="margin-left:20px;margin-top:-20px;">转存也在此处选择位置。<span style="color:red;">默认使用当前网页打开的目录位置，可以自行指定！</span></p></div>`)
        }
        ...
        let em = document.querySelector('em[rel=offlint_path_text]');
        if (em) {
            //弹窗时可能数据还在获取，延迟修改
            //fix: v3.3.1 优化”脚本修改比自带的快“
            //fix: v3.4 再次延长，优化”脚本修改比自带的快“
            delay(1000).then(t => {
                em.setAttribute('cid', currentFolder.id);
